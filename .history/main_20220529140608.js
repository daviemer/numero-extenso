...
function verificaTamanho(numero) {
  switch(numero){
    case numero >= 100 && numero < 1000: centena = listaCentena[1]
    case numero >= 200 && numero < 1000: centena = listaCentena[2]
    case numero >= 300 && numero < 1000: centena = listaCentena[3]
    case numero >= 400 && numero < 1000: centena = listaCentena[3]
    case numero >= 500 && numero < 1000: centena = listaCentena[3]
    case numero >= 600 && numero < 1000: centena = listaCentena[3]
    case numero >= 700 && numero < 1000: centena = listaCentena[3]
    case numero >= 800 && numero < 1000: centena = listaCentena[3]
    case numero >= 900 && numero < 1000: centena = listaCentena[3]
  } 
}
